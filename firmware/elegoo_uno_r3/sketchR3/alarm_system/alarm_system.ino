...
// =============================================================================
// Sensoren verarbeiten (Redundanz-Logik)
// =============================================================================
...
AlarmInput sensoren_verarbeite() {
  ...
  // Nur pruefen wenn scharf und noch nicht ausgeloest
  // Redundanz: Alarm NUR wenn BEIDE Sensoren offen
  if (fsm_istScharf() && !fsm_istAusgeloest()) {
    if (tuerOffen1 && tuerOffen2) {
