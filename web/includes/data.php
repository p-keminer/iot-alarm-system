...
$diagnosticDataDir = (is_string($configuredDataDir) && $configuredDataDir !== '')
    ? rtrim($configuredDataDir, '/\\')
    : dirname(__DIR__) . DIRECTORY_SEPARATOR . 'data';
$statusFile = $diagnosticDataDir . DIRECTORY_SEPARATOR . 'status.json';
$logFile    = $diagnosticDataDir . DIRECTORY_SEPARATOR . 'log.txt';
$csvFile    = $diagnosticDataDir . DIRECTORY_SEPARATOR . 'telemetry.csv';
