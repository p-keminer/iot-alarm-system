...
* **Sicherheit / Security:** Session-Hijacking-Prävention, Activity-Tracking,Session-Timeouts und 3-stufiger Brute Force Schutz.
  Session hijacking prevention via, activity tracking, session-timeouts and 3-stage brute force protection.
